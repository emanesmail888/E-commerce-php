...
<div class="panel " style="border:1px solid orange ;" ><!-- panel panel-default Starts -->
...
<table class="table table-warning table-striped" ><!-- table-bordered table-hover table-striped Starts -->
...
<a href="index.php?delete_cat=<?php echo $cat_id; ?>" class="text-warning" >
