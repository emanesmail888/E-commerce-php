...
<table class="table table-info table-hover table-striped"><!-- table table-bordered table-hover table-striped Starts -->
...
<a href="index.php?delete_rel=<?php echo $rel_id; ?>" class="text-info">

<i class="fa fa-trash-o text-info"></i> Delete
...
<a href="index.php?edit_rel=<?php echo $rel_id; ?>" class="text-info">
