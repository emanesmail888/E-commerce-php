...
<table class="table table-success table-hover table-striped"><!-- table table-bordered table-hover table-striped Starts -->
...
<a href="index.php?delete_coupon=<?php echo $coupon_id; ?>" class="text-success">

<i class="fa fa-trash-o" class="text-success"></i> Delete
...
<a href="index.php?edit_coupon=<?php echo $coupon_id; ?>" class="text-success">

<i class="fa fa-pencil" class="text-success"></i> Edit
