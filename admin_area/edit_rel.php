...
<div class="col-lg-8 offset-2"><!-- col-lg-12 Starts -->
...
<input type="text" name="rel_title" class="form-control  w-75 mr-1" value="<?php echo $r_title; ?>">
...
<input type="submit" name="update" class="btn btn-info form-control w-75 d-block mx-auto" value="Update Relation">
