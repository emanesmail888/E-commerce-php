...
<table class="table table-success table-striped" ><!-- table table-bordered table-hover table-striped Starts -->
...
<a href="index.php?user_delete=<?php echo $admin_id; ?>" class="text-success" >

<i class="fa fa-trash text-success" ></i> Delete
