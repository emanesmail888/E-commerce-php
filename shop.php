    ...
    <nav class="navbar navbar-expand-lg Nav   navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="navbar-collapse collapse ">
                ...
                <button class="btn navbar-btn btn-secondary ml-auto mr-1" type="button" data-toggle="collapse"
                    data-target="#search">
    ...
    <div class="col-md-4 ml-auto d-flex">
        ...
        <div class="collapse  " id="search">
            <form class="form-inline my-2 my-lg-0   " method="get" action="results.php">
                <input class="form-control my-2 mr-1" type="search" placeholder="Search" name="user-query"
