 ...
 <nav class="navbar navbar-expand-lg Nav   navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <form class="form-inline my-2 my-lg-0" method="get" action="results.php">
      <input class="form-control mr-sm-2" type="search" placeholder="Search" name="user-query" aria-label="Search" required>
      <button class="btn text-white btn-outline-light my-2 my-sm-0" type="submit">
...
<img src="admin_area/product_images/<?php echo $product_img1; ?>" class="h-25 w-50" >
