...
<div class="col-md-3 col-sm-6 ">
    ...
    <a href="../contact.php" class="text-info">Go To Contact Us Page</a>
    <hr class="hidden-md hidden-lg hidden-sm"> 
...
<div class="col-md-3 col-sm-6">
    ...
    <form class="mb-3" action="https://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('https://feedburner.google.com/fb/a/emailVerifySubmit?feedId=6861', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true"><!-- form Starts -->
